        ...
        <div class="markdown text-lg leading-normal text-gray-700">
          ...
          <ul class="ml-6">
            ...
            <li class="list-none text-xl">
              ...
              <a href="https://mallim.netlify.com/feed.xml"
          ...
          <p>
            ...
            <a href="https://github.com/mallim/mallim.netlify.com">GitHub</a>.
            Feel free to create a Pull Request if you find some issues in the
            text or you can just check the code if you are curious about
            Gridsome powered blogs.
          </p>
...
export default {
  ...
  computed: {
    ...
    ogDescription() {
      return "A blog of a Software Craftsman.";
    },
    ogImageUrl() {
