<template>
  <Layout>
    <main>
      ...
      >
        <!--
        <h1 class="font-bold text-lg sm:text-2xl mb-6">Stay Informed</h1>
        ...
        <div class="markdown text-lg leading-normal text-gray-700">
          ...
          <ul class="ml-6">
            ...
            <li>
              ...
              <a href="https://mallim.netlify.com/feed.xml">Subscribe to RSS Feed</a>
            </li>
          </ul>
          <hr>
          <h2>About me</h2>
          ...
          <p>
            ...
            <a
              href="https://github.com/mallim/mallim.netlify.com"
            >GitHub</a>. Feel free to create a Pull Request if you find some issues in the text or you can just check the code if you are curious about Gridsome powered blogs.
          </p>
          <div class="flex mt-12 justify-center">
            <div class="mr-2 ml-2 cursor-pointer twitter">
              <a aria-label="Twitter link" target="blank" href="https://twitter.com/mallim">
                <svg
            ...
            <div class="mr-2 ml-2 cursor-pointer-icon linkedin">
              <a
                target="blank"
                aria-label="Linkedin link"
                href="https://www.linkedin.com/in/mallim"
              >
                <svg
                  class="h-8 w-8 fill-current text-gray-500"
                  xmlns="https://www.w3.org/2000/svg"
            ...
            <div class="mr-2 ml-2 cursor-pointer-icon github">
              <a target="blank" aria-label="Github link" href="https://github.com/vojtechruz">
                <svg
                  class="h-8 w-8 fill-current text-gray-500"
                  xmlns="https://www.w3.org/2000/svg"
                  viewBox="0 0 496 512"
